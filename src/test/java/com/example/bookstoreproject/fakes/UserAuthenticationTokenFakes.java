...
public class UserAuthenticationTokenFakes {
    ...
    public static UserAuthenticationToken buildAdmin() {
        return new UserAuthenticationToken(UUID.randomUUID(), "admin", List.of(new SimpleGrantedAuthority("ROLE_ADMIN")));
    }
    public static UserAuthenticationToken buildContributor() {
        return new UserAuthenticationToken(UUID.randomUUID(), "contributor", List.of(new SimpleGrantedAuthority("ROLE_CONTRIBUTOR")));
    }
}
